...
class VoicePlayView @JvmOverloads constructor(
    ...
    init {
        ...
        lineWidth = typedArray.getDimensionPixelOffset(R.styleable.VoicePlayView_lineWidth, 10)
        typedArray.recycle()
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        for (i in 0..5) {
            ...
            // 计算高度的差值
            val offsetHeight = lineMaxHeight.times(offsetScale * (animHeightScale[i] - origHeightScale[i]))
            // 计算当前的高度
